  ...
  return (
    <>
      <group ref={tableGroup}>
        <Table />
        <PictureFrame
          image="frame2.jpg" // แก้แล้ว: ลบ / ออก
          position={[0, 0.735, 3]}
          rotation={[0, 5.6, 0]}
          scale={0.75}
        />
        <PictureFrame
          image="frame3.jpg" // แก้แล้ว: ลบ / ออก
          position={[0, 0.735, -3]}
          rotation={[0, 4.0, 0]}
          scale={0.75}
        />
        <PictureFrame
          image="frame4.jpg" // แก้แล้ว: ลบ / ออก
          position={[-1.5, 0.735, 2.5]}
          rotation={[0, 5.4, 0]}
          scale={0.75}
        />
        <PictureFrame
          image="frame1.jpg" // แก้แล้ว: ลบ / ออก
          position={[-1.5, 0.735, -2.5]}
          rotation={[0, 4.2, 0]}
          scale={0.75}
        />
...
export default function App() {
  ...
  useEffect(() => {
    const audio = new Audio("music.mp3"); // แก้แล้ว: ลบ / ออก
    audio.loop = true;
    audio.preload = "auto";
    ...
    <div className="App">
      ...
      >
        <Suspense fallback={null}>
          ...
          <Environment
            files={["shanghai_bund_4k.hdr"]} // แก้แล้ว: ลบ / ออก
